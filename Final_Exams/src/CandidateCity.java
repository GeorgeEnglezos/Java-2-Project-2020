...
public class CandidateCity {
    ...
    public CandidateCity(String City, String Country, String weather, double lat, double lon, int Cafes, int Museums, int Restaurants, int Bars, int Parks, int Zoos, int Monuments, int Viewpoints, int Beaches,double Temperature) {
        this.City = City;
